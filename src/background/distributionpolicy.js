...
class DistributionPolicy {
     ...
     *
     * @param {Account} cc The connection object to configure
     * @returns {Promise<Account>} The same connection object, with policy values applied
     */
    static async configure(cc) {
        ...
        const policyData = policyAccounts?.accounts?.[cc.accountId];
